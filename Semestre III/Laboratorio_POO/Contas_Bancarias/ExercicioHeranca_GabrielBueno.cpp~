...
class Conta_Poupanca:public Conta_Bancaria {
      ...
      public:
          ...
          virtual void Cadastro();			//Método para realização do cadastro 
          virtual float getSaldo();			//Método para a visualização do saldo atual
          void fazAniversario();		//Método para verificar se a conta fez aniversário e se deve aplicar o ganho ou não
    };

/*
Implementação da classe Conta_Poupanca feita por
...
void Conta_Poupanca::fazAniversario(){
	...
	data_aniversario[0] = atoi(Aniversario);	//Atribui a data de aniversário da conta para data_aniversario
